...
Preguntá en **lenguaje natural** y el agente genera el SQL, lo ejecuta sobre una
base SQLite y te explica el resultado — todo corriendo **localmente con Ollama**,
sin APIs de pago.
...
Copiá `.env.example` a `.env` para ajustar el modelo o el host:
...
> consultas complejas. Para mejor precisión podés usar un modelo más grande
